  ...
  return (
    <section className={`py-20 px-6 md:px-[140px] ${bgColorClass}`}>
      <div className="max-w-7xl mx-auto">
        ...
        {/* Highlights Grid - Staggered Card Animation */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-8">
          {highlights.map((highlight, index) => (
            <TextAnimation key={highlight.id || index} delay={0.4 + index * 0.1} className="h-full">
              <div className="group bg-white p-8 rounded-lg shadow-sm border h-full">
